...
public class IsGreaterExpression implements Expression< Boolean> {
    private final Expression<Double> leftExpression;
    private final Expression<Double> rightExpression;

    public IsGreaterExpression(Expression<Double> leftExpression, Expression<Double> rightExpression) {
