...
public class IsEqualNumericExpression implements Expression<Boolean> {
    private final Expression<Boolean> leftExpression;
    private final Expression<Boolean> rightExpression;

    public IsEqualNumericExpression(Expression<Boolean> leftExpression, Expression<Boolean> rightExpression) {
