...
import interpreter.expressions.ArithmeticExpressionParser;
import interpreter.expressions.BooleanExpressionParser;
import interpreter.expressions.Expression;
import interpreter.lexer.Token;
import interpreter.lexer.TokenType;
import interpreter.tree_parser.CustomCodeParser;
...
//            functionFrame.getTempValue().ifPresent(frame::setTempValue);
    ...
    private static  String getCode() {
        ...
        String filePath = "/home/zilvinas/git/reversals_repo/reversal_signals/RSVisualizer/src/main/java/zc/dev/stuff/interpreter/test_code/" + fileName;
